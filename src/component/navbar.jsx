  ...
  return (
    <div className='font-mono  flex items-center justify-center mx-auto p-6 '>
        <div className='flex items-center gap-3 p-2'>
            ...
            <h1 className='text-orange-500 font-bold text-2xl lg:text-4xl sm:text-3xl px-2 lg:ml-10 hidden md:flex  '>Kuku Jamboo </h1>
              ...
              <nav>
                  <ul className='flex flex-col pt-10 p-4 gap-8 text-2xl md:text-2xl text-orange-500'>
                     <Link activeClass="active" to="home"  smooth={true} offset={50} duration={500} >
                        <li className='hover:text-cyan-700 z-40 cursor-pointer font-semibold' onClick={handleClose} >Home</li>
                    </Link>
                    <Link activeClass="active" to="drinks"  smooth={true} offset={50} duration={500} >
                        <li className='hover:text-cyan-700 z-40 cursor-pointer font-semibold' onClick={handleClose}>Drinks</li>
                    </Link>
                    <Link activeClass="active" to="menu"  smooth={true} offset={50} duration={500} >
                        <li className='hover:text-cyan-700 z-40 cursor-pointer font-semibold' onClick={handleClose}>Menu</li>
                    </Link>
                    <Link activeClass="active" to="contact"  smooth={true} offset={50} duration={500} >
                        <li className='hover:text-cyan-700 z-40 cursor-pointer font-semibold' onClick={handleClose}>Contact</li>
                    </Link>
