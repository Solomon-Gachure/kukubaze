      ...
      <div name='contact' className='max-w-[1640px] font-mono m-auto py-2 px-4 '>
       ...
       <div className='max-w-[500px] mx-auto p-3' >
              <form className='flex flex-col justify-center gap-3' action="https://getform.io/f/db96c5fb-9063-4883-a850-e833759e93be" method="post">
                  <input required className='bg-gray-100 p-3 outline-none  rounded-lg outline-gray-100' name='name' type="text" placeholder='Enter Your Name' />
                  ...
                  <div className='max-w-[500px] flex justify-center'>
                      <button className='text-white bg-green-500 hover:scale-105 duration-300 p-2 rounded-lg border-green-500 font-bold'>SUBMIT</button>
                  </div>
